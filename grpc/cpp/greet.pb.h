...
class HelloRequest final :
 ...
 public:
  ...
  int32_t friendliness() const;
  void set_friendliness(int32_t value);
  private:
  int32_t _internal_friendliness() const;
  void _internal_set_friendliness(int32_t value);
  public:
...
// int32 friendliness = 3;
inline void HelloRequest::clear_friendliness() {
  friendliness_ = 0;
}
inline int32_t HelloRequest::_internal_friendliness() const {
  return friendliness_;
}
inline int32_t HelloRequest::friendliness() const {
  // @@protoc_insertion_point(field_get:greet.HelloRequest.friendliness)
  return _internal_friendliness();
}
inline void HelloRequest::_internal_set_friendliness(int32_t value) {
  
  friendliness_ = value;
}
inline void HelloRequest::set_friendliness(int32_t value) {
  _internal_set_friendliness(value);
  // @@protoc_insertion_point(field_set:greet.HelloRequest.friendliness)
}
